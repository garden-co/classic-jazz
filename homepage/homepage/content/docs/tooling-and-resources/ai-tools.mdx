...
<FileDownloadLink href="/react/llms-full.txt">llms-full.txt</FileDownloadLink>
</ContentByFramework>
<ContentByFramework framework="svelte">
  <FileDownloadLink href="/svelte/llms-full.txt">llms-full.txt</FileDownloadLink>
</ContentByFramework>
<ContentByFramework framework="react-native">
  <FileDownloadLink href="/react-native/llms-full.txt">llms-full.txt</FileDownloadLink>
</ContentByFramework>
<ContentByFramework framework="react-native-expo">
  <FileDownloadLink href="/react-native-expo/llms-full.txt">llms-full.txt</FileDownloadLink>
</ContentByFramework>
<ContentByFramework framework="vanilla">
  <FileDownloadLink href="/vanilla/llms-full.txt">llms-full.txt</FileDownloadLink>
</ContentByFramework>
